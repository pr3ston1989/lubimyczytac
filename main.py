    ...
    while True:
        ...
        try:
            if choice == '1':
                ...
                # Opcja 11: Zbieranie linków z plików cache (bez pobierania z internetu)
                # Przeszukuje katalog data/html_cache/ i wyciąga nowe linki do kolejki
                print("\n[📦] Tryb zbierania linków z cache.")
                print("    Przeszukam zapisane pliki HTML i wyciągnę z nich linki do kolejki.")
                
                scraper.mode = "spider"
                new_links_count = scraper.harvest_links_from_cache()
                
                if new_links_count > 0:
                    # Po zebraniu linków pytamy, czy od razu uruchomić pająka
