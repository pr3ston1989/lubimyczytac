...
# kategoria, autor, tag itd.). Chroni przed wygenerowaniem dziesiątek tysięcy
# adresów z bardzo dużych kategorii. Wartość 0 = brak limitu (generuj wszystkie
# strony aż do data-maxpage). Można nadpisać zmienną środowiskową MAX_LIST_PAGES.
